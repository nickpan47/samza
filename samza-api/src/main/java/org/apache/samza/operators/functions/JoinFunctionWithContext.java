...
@FunctionalInterface
public interface JoinFunctionWithContext<M extends MessageEnvelope, JM extends MessageEnvelope, RM extends MessageEnvelope> {
   ...
   */
  RM apply(M message, JM otherMessage, StreamContext context);
